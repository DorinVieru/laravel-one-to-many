...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 d-flex justify-content-center align-items-center">
            ...
            {{-- <a href="{{ route('admin.types.create') }}" > <button class="btn btn-success ms-5">Aggiungi un nuovo progetto</button></a> --}}
                    ...
                    @foreach ($types as $type)
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    {{-- VIEW BUTTON --}}
                                    <a href="{{ route('admin.types.show', ['type' => $type->id]) }}" class="btn btn-sm square btn-primary me-2" title="Visualizza i progetti per questo tipo"><i class="fas fa-eye"></i></a>
                                    {{-- EDIT BUTTON --}}
